...
Асинх Процедура ПутьКФайлуНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	...
	Диалог.Заголовок = "Выберите файл внешней обработки";
	Диалог.МножественныйВыбор = Ложь;
	Диалог.Фильтр = "Внешняя обработка|*.epf";
...
&НаКлиенте
Процедура ПодключатьсяОтладчикомПриИзменении(Элемент)
	НастроитьЭлементыФормы();
КонецПроцедуры
...
Асинх Процедура КомандаЗагрузитьИзФайла(Команда)
	...
	ИначеЕсли Не Описание.ПомещениеФайлаОтменено Тогда
		...
		Объект.ПутьКФайлу = Описание.СсылкаНаФайл.Файл.ПолноеИмя;
		Модифицированность = Истина;
	КонецЕсли;
КонецПроцедуры
...
Процедура НастроитьЭлементыФормы()
	...
	Элементы.ПодключатьсяОтладчиком.Видимость = Элементы.ГруппаВнешнийФайл.Видимость;
	Элементы.ПутьКФайлу.Видимость = Объект.ПодключатьсяОтладчиком И
		Объект.Расположение = Перечисления.скт_ВариантыРасположенияАлгоритмов.ВнешнийФайл;
