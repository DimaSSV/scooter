...
Функция ПолучитьРезультатКомпоновки(Метод, ВходныеПараметры = Неопределено) Экспорт
	...
	Для Каждого текАргумент Из ТаблицаАргументов Цикл
		...
		Если СтрокаПараметра <> Неопределено Тогда
			ЗначениеПараметра = Компоновщик.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(ПараметрКомпоновки);
			Если Не ПустаяСтрока(ЗначениеПараметра.ИдентификаторПользовательскойНастройки) Тогда
				ЗначениеПараметра = Компоновщик.ПользовательскиеНастройки.Элементы.Найти(ЗначениеПараметра.ИдентификаторПользовательскойНастройки);
				ЗначениеПараметра.Использование = Истина;
				ЗначениеПараметра.Значение = текАргумент.Значение;
			Иначе
				Компоновщик.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра(ПараметрКомпоновки, текАргумент.Значение);
			КонецЕсли;
		КонецЕсли;
