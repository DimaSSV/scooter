...
Процедура ЗалогироватьНачалоВызова(Метод, Аргументы, ЗапросHTTP = Неопределено)
	...
	скт_ОбщегоНазначенияВызовСервера.ЗаписатьВЖурнал("Начало вызова метода", СообщениеДляЖурнала, , Метод, Метод.Метаданные());
...
Процедура ЗалогироватьОкончаниеВызова(Метод, РезультатКомпоновки, РасширениеФайла, ЗапросHTTP = Неопределено)
	...
	скт_ОбщегоНазначенияВызовСервера.ЗаписатьВЖурнал("Окончание вызова метода", СообщениеДляЖурнала, , 
